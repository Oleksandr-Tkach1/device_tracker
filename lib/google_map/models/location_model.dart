...
class LocationModel {
  ...
  const LocationModel({required this.chatRoomId, required this.latitude, required this.longitude,});

  List <Object?> get props => [chatRoomId, latitude, longitude];
  // @override
  // int get hashCode => complete.hashCode ^ task.hashCode ^ note.hashCode ^ id.hashCode;

  @override
  String toString() {
    return 'Todo { task: $chatRoomId, note: $latitude, id: $longitude }';
  }
